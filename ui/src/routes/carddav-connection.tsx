...
function CopyButton({ text, label }: { text: string; label: string }) {
	...
	return (
		<Button variant="outline" size="sm" onClick={handleCopy} className="ml-2" title={`Copy ${label}`}>
			{copied ? (
				<>
	...
	return (
		<div className="container mx-auto p-6 space-y-6">
			<div>
				...
				<p className="text-muted-foreground">Configure your CardDAV client to sync contacts with this server.</p>
			</div>
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>Use these details to configure your CardDAV client</CardDescription>
				</CardHeader>
				<CardContent className="space-y-4">
					<div>
						...
						<div className="flex items-center">
							<code className="flex-1 px-3 py-2 bg-gray-100 dark:bg-gray-800 rounded-md text-sm break-all">{baseUrl}</code>
					...
					<div>
						...
						<p className="text-sm text-muted-foreground dark:text-gray-400">
							...
							<a href="/radicale-users" className="text-blue-600 dark:text-blue-400 hover:underline">
								Users
							</a>{' '}
					...
					<div>
						...
						<p className="text-sm text-muted-foreground dark:text-gray-400">
							For production use, ensure you're using HTTPS. If your server is behind a reverse proxy (like Traefik or Nginx), configure
							SSL/TLS at the proxy level.
						</p>
									...
									{users.map(user => {
										...
										return (
											<TableRow key={user.username}>
												...
												<TableCell>
													<CopyButton text={subscriptionUrl} label="Subscription URL" />
												</TableCell>
											</TableRow>
										)
									})}
						...
						<ol className="list-decimal list-inside space-y-1 text-sm text-muted-foreground dark:text-gray-400">
							...
							<li>
								...
								<ul className="list-disc list-inside ml-4 mt-1">
									<li>
										<strong>Server:</strong> {baseUrl.replace(/^https?:\/\//, '')}
									</li>
									<li>
