...
function AboutPage() {
  ...
  const envVars = Object.entries(info.environment).filter(
    ([_, value]) => value !== null,
  )
    ...
    <div className="container mx-auto p-6 max-w-4xl">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Debug information and system details
        </p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Configuration and environment settings (sensitive values are
              masked)
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-sm text-muted-foreground space-y-2">
              <p>
                Shared Contacts is a self-hostable CardDAV server for managing
                shared contacts with a modern web-based management interface.
              </p>
              <Separator />
              <p>
