...
export function ContactForm({ contact, onSubmit, onCancel }: ContactFormProps) {
  ...
  const [labels, setLabels] = useState<ContactField[]>(
    initializeOptionalArray(contact?.labels),
  )
  const [logos, setLogos] = useState<ContactField[]>(
    initializeOptionalArray(contact?.logos),
  )
  const [sounds, setSounds] = useState<ContactField[]>(
    initializeOptionalArray(contact?.sounds),
  )
  const [keys, setKeys] = useState<ContactField[]>(
    initializeOptionalArray(contact?.keys),
  )
  const [customFields, setCustomFields] = useState<
    Array<{ key: string; value: string; params?: string[] }>
  >(contact?.custom_fields && contact.custom_fields.length > 0 ? contact.custom_fields : [])
  const [orgUnitsInput, setOrgUnitsInput] = useState(
    contact?.org_units?.join(', ') || '',
  )
  ...
  const updateCustomField = (
    index: number,
    updates: Partial<{ key: string; value: string; params?: string[] }>,
  ) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const nonEmptyCustomFields = customFields.filter(
  ...
  const shouldShowAdvancedField = (hasValue: boolean) =>
    showAdvanced || hasValue
            ...
            <Field>
              ...
              <FieldContent>
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, name_prefix: e.target.value })
                  }
            ...
            <Field>
              ...
              <FieldContent>
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, name_suffix: e.target.value })
                  }
            ...
            <Field>
              ...
              <FieldContent>
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, mailer: e.target.value })
                  }
                />
              </FieldContent>
            </Field>
            ...
            <Field>
              ...
              <FieldContent>
                <Input
                  ...
                  value={formData.geo}
                  onChange={(e) =>
                    setFormData({ ...formData, geo: e.target.value })
                  }
            ...
            <Field>
              ...
              <FieldContent>
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, sort_string: e.target.value })
                  }
                />
              </FieldContent>
            </Field>
